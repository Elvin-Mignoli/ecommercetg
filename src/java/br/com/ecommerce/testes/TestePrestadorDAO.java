...
public class TestePrestadorDAO {
    ...
    public static void main(String[] args) throws ParseException, SQLException {
       ...
       /* Endereco end = new Endereco("RUA:PEDRO SEGUNDO", "50", "08655152","COLORADO" , "SUZANO", "SP", "CASA DOS FUNDOS");
         ...
         "Prestador", "marus.silva@gmail.com", "123",1, lista);
       ...
       /*PrestadorServico prest = new PrestadorServico();
        ...
        comp.setId(10);
        lista.add(comp);
        PrestadorServico prestador = new PrestadorServico("Marcus", "Mignoli", "1998/05/11", "0000000000", end, contato, "M", "Cliente",
                "marcus@hotmail.com", "1235", 1, lista);
        prestador.setId(12);
        PrestadorServicoDAO prestDAO = new PrestadorServicoDAO();
