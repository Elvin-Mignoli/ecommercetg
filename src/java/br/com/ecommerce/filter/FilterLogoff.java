...
public class FilterLogoff implements Filter
{
            ...
            throws IOException, ServletException
    {
        if (debug)
        {
            log("FilterLogoff:DoBeforeProcessing");
        }
            ...
            throws IOException, ServletException
    {
        if (debug)
        {
            log("FilterLogoff:DoAfterProcessing");
        }
    ...
    {        
        ...
        if (filterConfig != null)
        {
            if (debug)
            {                
                log("FilterLogoff:Initializing filter");
            }
        }
    }
    ...
    public String toString()
    {
        ...
        StringBuffer sb = new StringBuffer("FilterLogoff(");
