 ...
 * @author Elvin
 */
public class InteressadorDAO extends AbstractDAO{

    public InteressadorDAO() {
    }

    public InteressadorDAO(Connection conexao) {
        super(conexao);
    }
    ...
    public void atualizar(EntidadeDominio entidade) throws SQLException {
        ...
        try{
            ...
            pst.setString(3, usuario.getPedido().getStatus().NEGOCIACAO.toString());
            pst.executeUpdate();
            conexao.commit();
    ...
    public List<EntidadeDominio> consultar(EntidadeDominio entidade) throws SQLException {
        try{   
            ...
            while(resultado.next()){
                ...
                prestador.setId(resultado.getInt("id_pedidos"));
                lista.add(prestador);
            }
            return lista;
        }catch (SQLException ex)
