...
<html>
    <head>
        ...
        <link href="../../css/PrestadorEntrada.css" rel="stylesheet" type="text/css"/>
    </head>
        ...
        <div class="table-responsive" id="div_caixa_entrada">
            <table class="table-bordered table-striped col-lg-12 table-responsive">
                <tr>
                    ...
                    <c:if test="${sessionScope.user.entrada != null}">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    ...
                                    <button type="button" value="Excluir" id="btn_excluir"  class="btn btn-info" 
                                            onclick="excluirMensagemFront('Excluir',${sessionScope.user.entrada.id},${list.id})">Excluir</button>
                                </td>
                            </tr>
                        </c:forEach>
                   </c:if>
