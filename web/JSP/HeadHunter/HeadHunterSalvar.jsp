...
<html>
    <head>
        ...
        <title>Cadastrar HeadHunter</title>
    </head>
    <body>
        <div class="page-header text-center">
            <h1>Cadastro do HeadHunter</h1>
        </div>
        
         <!-- DIV CONTAINER DA APLICAÇÂO -->
        <div class="container">
            <form id="form_cadastro"  method="POST" action="SalvarHeadHunter" id="form_cadastrar">
                <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" required="required" name="txtNome" class="form-control" placeholder="Digite seu Nome" value="${requestScope.head.nome}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="txtSobrenome" class="form-control" placeholder="Digite seu Sobrenome" required="required" value="${requestScope.head.sobrenome}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">Nome da Empresa</span>
                                    <input type="text" name="txtNomeEmpresa" class="form-control" placeholder="Digite o nome da empresa" required="required" value="${requestScope.head.nome_empresa}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="div_cpf"  hidden="false">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="txtCpf" class="form-control" id="input_cpf"  value="${requestScope.head.cpf}" onchange="validaCPF()"/>
                            ...
                            <div class="form-group" id="div_cnpj" hidden="false">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="txtCnpj" class="form-control" id="input_cnpj"  value="${requestScope.head.cnpj}" onchange="validaCNPJ()"/>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" id="div_email">
                                <div class="input-group">
                                    ...
                                    <input type="email" required="required" name="txtLogin" class="form-control" value="${requestScope.headfom.email}" id="input_email" onchange="validaEmail()"/>
                                </div>
