          ...
          <legend><span>Cadastro do cliente</span></legend>
            <form id="form_cadastro" method="POST" action="SalvarCliente">
                ...
                <fieldset class="pessoais">
                    ...
                    <fieldset id="endereco_layout" class="pessoais">
                        ...
                        <table>
                            <tr>
                                ...
                                <td><label for="numero">N°</label><input type="number" max="10000" name="textNumero" id="numero" required="true"/></td>
                            </tr>
                            <tr>
                    ...
                    <p><input type="submit" value="Cadastrar" id="button_cadastrar" name="bCadastrar"/></p>
                </form>
            </fieldset>
